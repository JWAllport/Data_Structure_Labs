...
#ifndef LAB7_HASHNODE_H
#define LAB7_HASHNODE_H
#include <iostream>
...
class hashNode {
    ...
    //If this set of words gets to be larger than the valuesSize of the array, then you must re-allocate the array double in size and copy over all the old values
